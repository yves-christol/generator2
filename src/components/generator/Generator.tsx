...
const Generator: Component = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div class="flex flex-row bg-gradient-to-b from-black via-gray-500 to-black justify-center">
        <input 
          value={key()}
          type='password'
          class="m-1 sm:m-3 w-24 sm:w-48 md:w-64 sm:p-1 md:p-2 bg-gray-700 md:mr-2 rounded-full"
